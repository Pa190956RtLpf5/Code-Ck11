...
client = interactions.Client("ใส่โทเคนบอท", intents=interactions.Intents.DEFAULT | interactions.Intents.GUILD_MESSAGES)

@client.event
async def on_start():
	print('Online !')
	
@client.command(name="views", description="ปั๊มวิว tiktok ")
...
@client.command(name="follows", description="ปั๊มฟอล tiktok ")
...
@client.command(name="share", description="ปั๊มแชร์ tiktok ")
